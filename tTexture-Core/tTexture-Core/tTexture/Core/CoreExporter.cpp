...
namespace tTexture {
	...
	CoreExporter::OutputFormat CoreExporter::RetrieveOutputFormat(const std::string& filepath)
	{
	...
	std::shared_ptr<tTexture::Texture2D> CoreExporter::ConvertToHCross(const std::shared_ptr<TextureCube>& sourceTexture) const
	{
	...
	std::shared_ptr<Texture2D> CoreExporter::PrepareHCross(const std::shared_ptr<TextureCube>& sourceTexture) const
	{
	...
	std::shared_ptr<tTexture::Texture2D> CoreExporter::PrepareHCrossNoAlpha(const std::shared_ptr<TextureCube>& sourceTexture) const
	{
	...
	Face CoreExporter::SelectFace(uint32_t faceSize, uint32_t x, uint32_t y) const
	{
	...
	std::shared_ptr<tTexture::Texture2D> CoreExporter::ConvertTextureCubeToFormat(const std::shared_ptr<TextureCube>& sourceTexture, CubeFormat desiredFormat)
	{
	...
	std::shared_ptr<tTexture::Texture2D> CoreExporter::ConvertToVCross(const std::shared_ptr<TextureCube>& sourceTexture) const
	{
